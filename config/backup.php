...
return [
    ...
    'monitor_backups' => [
        [
            ...
            'health_checks' => [
                ...
                \Spatie\Backup\Tasks\Monitor\HealthChecks\MaximumStorageInMegabytes::class => 1900,
            ],
        ],
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            'delete_oldest_backups_when_using_more_megabytes_than' => 1900,
        ],
    ],
