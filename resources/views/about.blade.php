...
<div class="h-vh position-relative">
  ...
  <div style="bottom: 10%; left: 5%;" class="position-absolute d-flex">
    <img style="height: 1px; padding-top: .5rem;" class="mr-3" data-match="#overlay-text" src="{{ url('/images/cdb-logo.png') }}" alt="Crazy Dutch Bikers logo">
    <div id="overlay-text">
      <h2>
        De <span class="h1 text-primary">Cra<span class="h5 text-primary">Z</span>y</span> Dutch Bikers
      </h2>
