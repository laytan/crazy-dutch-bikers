...
export default class ImageUpload {
  ...
  /**
   * Fill the wrapper element with our static elements
  ...
  /**
   * Render our image upload with the current state
   * and bind a listener to the trash icon to remove the image
   */
  private render() {
    if (!this.renderEl) {
      return;
