<template>
  <div>
    <div
      class="w-100 h-100 image-upload position-relative bg-cdbb d-flex justify-content-center align-items-center"
    >
      <i
        v-if="hasImg()"
        @click="removeImg"
        class="h-100 text-danger position-absolute top-0 right-0 mt-2 mr-2 fas fa-trash"
      ></i>
      <img
        ref="preview"
        v-if="hasImg()"
      ...
      <div class="input-wrapper">
        <label v-show="!hasImg()" :for="inputId" class="btn btn-primary"
          ><i class="fas fa-upload mr-2"></i>
          <span class="v-align-middle"> Kies een foto </span>
        </label>
        <input
          ref="inputEl"
          @change="previewImg"
