...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // Implicitly grant "Super Admin" role all permission if Response::deny has not yet been returned in the gates before
        ...
        Gate::define('make-admin', fn(User $user, User $otherUser) => !$otherUser->hasRole('super-admin') && $user->hasRole('super-admin'));
